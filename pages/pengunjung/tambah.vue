<template>
    ...
    <div class="row">
        ...
        <form @submit.prevent="kirimData">
            <div class="mb-3">
            <input v-model="form.nama" type="text" class="form-control-lg form-control rounded-5" placeholder="nama..." />
            </div>
            <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                <select v-model="form.kelas" class="form-control-lg form-select rounded-5">
            ...
            <div class="mb-3">
            <select v-model="form.keperluan" class="form-control-lg form-select rounded-5">
